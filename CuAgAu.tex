...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.7\textheight]{img/JWST_Telescope_alignment_evaluation_image_labeled.jpg}
		\caption*{Zaostření zrcadla JWST.\footnote[frame]{Zdroj: \href{https://commons.wikimedia.org/wiki/File:JWST_Telescope_alignment_evaluation_image_labeled.jpg}{NASA/Commons}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
			...
			\end{itemize}
			\begin{figure}
				\adjincludegraphics[height=.8\textheight, rotate=90]{img/Gold-trifluoride-spiral-side-3D-balls.png}
